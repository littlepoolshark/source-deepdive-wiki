...
关于服务端渲染的 Suspense boundaries 的 hydration，请参阅 [Hydration System](/6.3-hydration-system)。关于 Suspense 如何与 Server Components 和流式 SSR 集成，请参阅 [React Fizz (Streaming SSR)](/5.1-react-fizz-(streaming-ssr))。
...
来源：[packages/react-reconciler/src/ReactFiberBeginWork.js#L1-L100](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberBeginWork.js#L1-L100), [packages/react-reconciler/src/ReactFiberClassComponent.js#L1-L50](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberClassComponent.js#L1-L50)
...
来源：[packages/react-reconciler/src/ReactFiberSuspenseComponent.js#L24-L36](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberSuspenseComponent.js#L24-L36), [packages/react-reconciler/src/ReactWorkTags.js:70](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactWorkTags.js:70)
...
2. **在工作循环中捕获**：工作循环在 `handleThrow` 中捕获抛出的值（[packages/react-reconciler/src/ReactFiberWorkLoop.js#L1800-L1900](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L1800-L1900)）
3. **throwException**：识别抛出的内容并找到最近的 Suspense boundary（[packages/react-reconciler/src/ReactFiberThrow.js#L1-L100](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L1-L100)）
4. **标记边界**：在 Suspense boundary fiber 上设置 `ShouldCapture` 标志（[packages/react-reconciler/src/ReactFiberBeginWork.js#L3800-L3900](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberBeginWork.js#L3800-L3900)）
5. **展开堆栈**：通过 `unwindWork` 展开 fiber 树，弹出上下文并检查每个 fiber 的 `ShouldCapture`（[packages/react-reconciler/src/ReactFiberUnwindWork.js#L156-L183](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L156-L183)）
6. **转换为 DidCapture**：当展开到达 Suspense boundary 时，将 `ShouldCapture` 转换为 `DidCapture` 标志（[packages/react-reconciler/src/ReactFiberUnwindWork.js#L170-L180](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L170-L180)）
7. **使用 Fallback 重新渲染**：重新渲染 Suspense boundary，此时显示 fallback 而不是子组件（[packages/react-reconciler/src/ReactFiberBeginWork.js#L3800-L4000](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberBeginWork.js#L3800-L4000)）
8. **附加监听器**：通过 `attachPingListener` 将 ping 监听器附加到抛出的 promise（[packages/react-reconciler/src/ReactFiberThrow.js#L400-L500](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L400-L500)）
9. **Promise 解析**：当 promise 解析时，ping 回调触发 `retryDehydratedSuspenseBoundary` 或调度更新
10. **重试渲染**：在 retry lane 重新渲染，尝试再次渲染子组件（[packages/react-reconciler/src/ReactFiberWorkLoop.js#L2000-L2100](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L2000-L2100)）

来源：[packages/react-reconciler/src/ReactFiberWorkLoop.js#L1800-L2000](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L1800-L2000), [packages/react-reconciler/src/ReactFiberThrow.js#L1-L500](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L1-L500), [packages/react-reconciler/src/ReactFiberUnwindWork.js#L156-L183](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L156-L183)
...
- `pushPrimaryTreeSuspenseHandler(workInProgress)` - 将新的 Suspense boundary 推入堆栈（[packages/react-reconciler/src/ReactFiberSuspenseContext.js#L100-L150](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberSuspenseContext.js#L100-L150)）
...
- `getSuspenseHandler()` - 返回当前最内层的 Suspense boundary（[packages/react-reconciler/src/ReactFiberSuspenseContext.js#L200-L250](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberSuspenseContext.js#L200-L250)）

来源：[packages/react-reconciler/src/ReactFiberSuspenseContext.js#L1-L300](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberSuspenseContext.js#L1-L300), [packages/react-reconciler/src/ReactFiberBeginWork.js#L3700-L3800](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberBeginWork.js#L3700-L3800)
...
- `RetryQueue`：存储在 Suspense boundaries 的 `workInProgress.updateQueue` 上，包含正在跟踪的 `Wakeable`（promise）（[packages/react-reconciler/src/ReactFiberSuspenseComponent.js#L100-L120](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberSuspenseComponent.js#L100-L120)）
- `claimNextRetryLane()`：从 `RetryLanes` 位掩码中分配特定的 retry lane（[packages/react-reconciler/src/ReactFiberLane.js#L850-L900](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberLane.js#L850-L900)）
- `attachPingListener()`：将回调附加到 promise，在解析时调度更新（[packages/react-reconciler/src/ReactFiberThrow.js#L400-L500](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L400-L500)）
- `retryDehydratedSuspenseBoundary()`：为 dehydrated boundaries 调度重试（[packages/react-reconciler/src/ReactFiberWorkLoop.js#L1200-L1300](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L1200-L1300)）

来源：[packages/react-reconciler/src/ReactFiberSuspenseComponent.js#L100-L150](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberSuspenseComponent.js#L100-L150), [packages/react-reconciler/src/ReactFiberLane.js#L850-L900](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberLane.js#L850-L900), [packages/react-reconciler/src/ReactFiberThrow.js#L400-L500](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L400-L500)
...
来源：[packages/react-reconciler/src/ReactFiberWorkLoop.js#L431-L441](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L431-L441)
...
来源：[packages/react-reconciler/src/ReactFiberClassComponent.js#L1-L100](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberClassComponent.js#L1-L100)
...
2. **在工作循环中捕获**：工作循环在 `handleThrow` 中捕获错误（[packages/react-reconciler/src/ReactFiberWorkLoop.js#L1800-L1900](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L1800-L1900)）
3. **throwException**：检查错误并向上遍历 fiber 树以找到 error boundary（[packages/react-reconciler/src/ReactFiberThrow.js#L200-L400](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L200-L400)）
4. **识别边界**：查找具有 `getDerivedStateFromError` 或 `componentDidCatch` 的类组件（[packages/react-reconciler/src/ReactFiberThrow.js#L250-L350](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L250-L350)）
5. **创建错误更新**：调用 `createClassErrorUpdate` 在边界的队列上创建更新（[packages/react-reconciler/src/ReactFiberThrow.js#L300-L350](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L300-L350)）
6. **设置 ShouldCapture**：在 error boundary fiber 上标记 `ShouldCapture` 标志
7. **展开**：通过 `unwindWork` 展开堆栈，检查每个 fiber 的 `ShouldCapture`（[packages/react-reconciler/src/ReactFiberUnwindWork.js#L77-L93](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L77-L93)）
8. **转换为 DidCapture**：当展开到达 error boundary 时，将 `ShouldCapture` 转换为 `DidCapture`（[packages/react-reconciler/src/ReactFiberUnwindWork.js#L83-L91](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L83-L91)）
9. **处理更新**：在重新渲染期间，处理错误更新并调用 `getDerivedStateFromError`（[packages/react-reconciler/src/ReactFiberClassUpdateQueue.js#L200-L300](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberClassUpdateQueue.js#L200-L300)）
10. **渲染 Fallback**：使用更新后的状态重新渲染边界，显示 fallback UI
11. **Commit 阶段**：在 commit 期间，使用错误和错误信息调用 `componentDidCatch`（[packages/react-reconciler/src/ReactFiberCommitWork.js#L1000-L1100](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberCommitWork.js#L1000-L1100)）

来源：[packages/react-reconciler/src/ReactFiberWorkLoop.js#L1800-L1900](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L1800-L1900), [packages/react-reconciler/src/ReactFiberThrow.js#L200-L400](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L200-L400), [packages/react-reconciler/src/ReactFiberUnwindWork.js#L77-L93](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L77-L93)
...
来源：[packages/react-reconciler/src/ReactFiberThrow.js#L250-L350](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L250-L350)
...
来源：[packages/react-reconciler/src/ReactFiberThrow.js#L1-L600](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L1-L600)
...
来源：[packages/react-reconciler/src/ReactFiberFlags.js#L1-L200](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberFlags.js#L1-L200), [packages/react-reconciler/src/ReactFiberUnwindWork.js#L66-L200](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L66-L200)
...
- **ClassComponent**：如果是 context provider，弹出遗留上下文（[packages/react-reconciler/src/ReactFiberUnwindWork.js#L77-L93](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L77-L93)）
- **HostRoot**：弹出所有根级上下文（[packages/react-reconciler/src/ReactFiberUnwindWork.js#L95-L118](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L95-L118)）
- **SuspenseComponent**：弹出 suspense handler 并检查 dehydrated boundaries（[packages/react-reconciler/src/ReactFiberUnwindWork.js#L156-L183](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L156-L183)）
- **SuspenseListComponent**：弹出 suspense list context（[packages/react-reconciler/src/ReactFiberUnwindWork.js#L184-L194](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L184-L194)）

来源：[packages/react-reconciler/src/ReactFiberUnwindWork.js#L66-L250](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberUnwindWork.js#L66-L250)
...
来源：[packages/react-reconciler/src/ReactFiberWorkLoop.js#L1700-L2000](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L1700-L2000)
...
来源：[packages/react-reconciler/src/ReactFiberThrow.js#L400-L500](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L400-L500), [packages/react-reconciler/src/ReactFiberWorkLoop.js#L1000-L1100](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L1000-L1100)
...
- `reenterHydrationStateFromDehydratedSuspenseInstance()`：为 dehydrated 内容重新进入 hydration 模式（[packages/react-reconciler/src/ReactFiberHydrationContext.js#L400-L500](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberHydrationContext.js#L400-L500)）
...
来源：[packages/react-reconciler/src/ReactFiberHydrationContext.js#L1-L500](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberHydrationContext.js#L1-L500), [packages/react-reconciler/src/ReactFiberBeginWork.js#L3900-L4100](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberBeginWork.js#L3900-L4100)
...
来源：[packages/react-reconciler/src/ReactFiberThrow.js#L100-L200](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberThrow.js#L100-L200), [packages/react-reconciler/src/ReactFiberClassUpdateQueue.js#L100-L200](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberClassUpdateQueue.js#L100-L200)
...
来源：[packages/react-reconciler/src/ReactFiberCommitWork.js#L800-L1000](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberCommitWork.js#L800-L1000), [packages/react-reconciler/src/ReactFiberCommitEffects.js#L200-L400](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberCommitEffects.js#L200-L400)
...
4. **节流**：React 节流显示多个 fallback，以避免 UI 闪烁（[packages/react-reconciler/src/ReactFiberWorkLoop.js#L500-L520](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js#L500-L520)）
...
来源：[packages/react-reconciler/src/ReactFiberSuspenseComponent.js#L150-L250](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberSuspenseComponent.js#L150-L250), [packages/react-reconciler/src/ReactFiberBeginWork.js#L4100-L4300](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberBeginWork.js#L4100-L4300)
...
来源：[packages/react-reconciler/src/ReactFiberWorkLoop.js:514](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberWorkLoop.js:514)
...
来源：[packages/react-reconciler/src/ReactFiberLane.js#L93-L99](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberLane.js#L93-L99)

### Error Boundary 重新渲染优化

捕获错误后，React 跳过渲染 error boundary 的子组件，直接转到 fallback，避免浪费工作。

来源：[packages/react-reconciler/src/ReactFiberBeginWork.js#L1200-L1300](https://github.com/facebook/react/blob/main/packages/react-reconciler/src/ReactFiberBeginWork.js#L1200-L1300)

...
关于使用 Suspense 边界进行 HTML 流式传输的详细实现，请参阅 [React Fizz (Streaming SSR)](#5.1)。关于 Server Components 序列化和 RSC 协议，请参阅 [React Server Components (Flight)](#5.2)。关于构建系统集成，请参阅 [Build Integration for Server Components](#5.3)。关于 server actions 和双向通信，请参阅 [Server Actions and Bidirectional Communication](#5.4)。
...
来源：[packages/react-server/src/ReactFizzServer.js:1-100](), [packages/react-server/src/ReactFlightServer.js:1-100]()
...
来源：[packages/react-server/src/ReactFlightServer.js:1-200](), [packages/react-server/src/ReactFizzServer.js:1-200](), [packages/react-client/src/ReactFlightClient.js:1-200]()
...
来源：[packages/react-server/src/ReactFizzServer.js:360-554](), [packages/react-server/src/ReactFlightServer.js:527-841]()
...
来源：[packages/react-server/src/ReactFizzServer.js:791-802](), [packages/react-server/src/ReactFlightServer.js:2420-2500]()
...
来源：[packages/react-dom-bindings/src/server/ReactFizzConfigDOM.js:1-300]()
...
来源：[packages/react-server/src/ReactFlightServer.js:2700-3200](), [packages/react-client/src/ReactFlightClient.js:149-164]()
...
**预渲染：**
- `createPrerenderRequest()` [packages/react-server/src/ReactFizzServer.js:623-655]()：创建跟踪推迟空洞（postponed holes）以便恢复的请求
- `resumeRequest()` [packages/react-server/src/ReactFizzServer.js:657-749]()：从 `PostponedState` 恢复

来源：[packages/react-dom/src/server/ReactDOMFizzServerNode.js:1-300](), [packages/react-dom/src/server/ReactDOMFizzServerBrowser.js:1-200]()
...
**预渲染：**
- `createPrerenderRequest()` [packages/react-server/src/ReactFlightServer.js:811-841]()：创建带有 `onAllReady` 和 `onFatalError` 回调的请求
- 预渲染可以恢复或转换为静态输出

来源：[packages/react-server/src/ReactFlightServer.js:781-841]()
...
来源：[packages/react-server/src/ReactFizzServer.js:2100-2300](), [packages/react-server/src/ReactFlightServer.js:2600-2800]()
...
**Fizz** 使用 `progressiveChunkSize` [packages/react-server/src/ReactFizzServer.js:437]()：
...
来源：[packages/react-server/src/ReactFizzServer.js:422-472](), [packages/react-server/src/ReactFlightServer.js:2420-2500]()
...
来源：[packages/shared/ReactFeatureFlags.js](), [packages/react-server/src/ReactFizzServer.js:177-187](), [packages/react-server/src/ReactFlightServer.js:14-20]()
...
关于实现细节，请参阅子页面：[React Fizz (Streaming SSR)](#5.1) 了解 HTML 生成，[React Server Components (Flight)](#5.2) 了解 RSC 协议，[Build Integration for Server Components](#5.3) 了解打包器集成，以及 [Server Actions and Bidirectional Communication](#5.4) 了解客户端到服务端的 RPC。

...
关于控制各环境启用功能的 Feature Flags，请参阅 [Feature Flags 系统](/2-feature-flags-system)。关于发布渠道和版本管理，请参阅 [发布渠道与版本管理](/3.2-release-channels-and-versioning)。关于 CI/CD 和产物准备，请参阅 [CI/CD 与产物管理](/3.3-cicd-and-artifact-management)。
...
[scripts/rollup/bundles.js#L69-L1244](https://github.com/facebook/react/blob/main/scripts/rollup/bundles.js#L69-L1244) 中的 bundle 定义指定了所有可能的构建输出。每个 bundle 配置包含：
...
来源：[scripts/rollup/bundles.js#L10-L54](https://github.com/facebook/react/blob/main/scripts/rollup/bundles.js#L10-L54)

---

## 模块分叉机制

模块分叉允许 React 在构建时用环境特定的实现替换特定模块。分叉系统定义在 [scripts/rollup/forks.js#L52-L482](https://github.com/facebook/react/blob/main/scripts/rollup/forks.js#L52-L482)。
...
来源：[scripts/rollup/forks.js#L52-L482](https://github.com/facebook/react/blob/main/scripts/rollup/forks.js#L52-L482), [scripts/rollup/modules.js#L64-L81](https://github.com/facebook/react/blob/main/scripts/rollup/modules.js#L64-L81)
...
Fork 逻辑：[scripts/rollup/forks.js#L134-L191](https://github.com/facebook/react/blob/main/scripts/rollup/forks.js#L134-L191)
...
Fork 逻辑：[scripts/rollup/forks.js#L242-L274](https://github.com/facebook/react/blob/main/scripts/rollup/forks.js#L242-L274)

`findNearestExistingForkFile` 函数 [scripts/rollup/forks.js#L29-L43](https://github.com/facebook/react/blob/main/scripts/rollup/forks.js#L29-L43) 尝试逐步缩短的段组合：
...
Fork 逻辑：[scripts/rollup/forks.js#L55-L89](https://github.com/facebook/react/blob/main/scripts/rollup/forks.js#L55-L89)
...
Fork 逻辑：[scripts/rollup/forks.js#L276-L392](https://github.com/facebook/react/blob/main/scripts/rollup/forks.js#L276-L392)
...
Rollup 插件管线通过多个阶段转换源代码。管线在 [scripts/rollup/build.js#L354-L546](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L354-L546) 中构建。
...
来源：[scripts/rollup/build.js#L380-L539](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L380-L539)

### 关键插件详情

**Babel 配置** [scripts/rollup/build.js#L143-L172](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L143-L172)
...
**Closure Compiler 配置** [scripts/rollup/build.js#L470-L500](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L470-L500)
...
**常量替换** [scripts/rollup/build.js#L432-L442](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L432-L442)
...
Host 配置注册在 [scripts/shared/inlinedHostConfigs.js#L9-L357](https://github.com/facebook/react/blob/main/scripts/shared/inlinedHostConfigs.js#L9-L357)。每个配置指定：
...
来源：[scripts/shared/inlinedHostConfigs.js#L9-L357](https://github.com/facebook/react/blob/main/scripts/shared/inlinedHostConfigs.js#L9-L357)

### Fork 路径解析

`findNearestExistingForkFile` 函数 [scripts/rollup/forks.js#L29-L43](https://github.com/facebook/react/blob/main/scripts/rollup/forks.js#L29-L43) 通过尝试逐步缩短的路径段来解析 fork：
...
Bundle 输出按环境和包组织。输出路径生成在 [scripts/rollup/packaging.js#L48-L115](https://github.com/facebook/react/blob/main/scripts/rollup/packaging.js#L48-L115)。
...
代码：[scripts/rollup/packaging.js#L48-L115](https://github.com/facebook/react/blob/main/scripts/rollup/packaging.js#L48-L115)
...
**NODE_DEV 包装器** [scripts/rollup/wrappers.js#L86-L95](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L86-L95)
...
**FB_WWW_DEV 包装器** [scripts/rollup/wrappers.js#L107-L116](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L107-L116)
...
**RN_OSS_DEV 包装器** [scripts/rollup/wrappers.js#L128-L137](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L128-L137)
...
来源：[scripts/rollup/wrappers.js#L58-L169](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L58-L169)

### Reconciler 包装器

reconciler（react-reconciler 包）使用特殊的工厂函数包装器，接受 host 配置：

**NODE_DEV Reconciler** [scripts/rollup/wrappers.js#L172-L186](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L172-L186)
...
来源：[scripts/rollup/wrappers.js#L171-L263](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L171-L263)

### 许可证头部

许可证头部因 bundle 类型而异。OSS 构建示例 [scripts/rollup/wrappers.js#L326-L336](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L326-L336)：
...
Facebook 构建包含 Flow/lint 指令 [scripts/rollup/wrappers.js#L362-L374](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L362-L374)：
...
来源：[scripts/rollup/wrappers.js#L265-L492](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L265-L492)
...
来源：[scripts/rollup/build.js#L828-L896](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L828-L896)
...
代码：[scripts/rollup/build.js#L94-L98](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L94-L98)
...
代码：[scripts/rollup/build.js#L100-L104](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L100-L104), [scripts/rollup/build.js#L548-L583](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L548-L583)

**跳过逻辑** [scripts/rollup/build.js#L548-L583](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L548-L583)
...
构建后，包会为 npm 发布做准备 [scripts/rollup/packaging.js#L253-L284](https://github.com/facebook/react/blob/main/scripts/rollup/packaging.js#L253-L284)：
...
过滤步骤 [scripts/rollup/packaging.js#L171-L251](https://github.com/facebook/react/blob/main/scripts/rollup/packaging.js#L171-L251) 从 `package.json` 的 `files` 字段和 `exports` 映射中移除当前发布渠道未构建的入口点。
...
[scripts/rollup/modules.js#L10-L28](https://github.com/facebook/react/blob/main/scripts/rollup/modules.js#L10-L28) 声明外部依赖在导入时是否有副作用：
...
这允许在生产构建中对未使用的 DEV 专用导入进行 tree-shaking。`pureExternalModules` 列表传递给 Rollup 的 treeshake 配置 [scripts/rollup/build.js#L656-L666](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L656-L666)。

### 已知全局变量

对于 UMD/IIFE bundle，外部依赖映射到全局变量 [scripts/rollup/modules.js#L31-L38](https://github.com/facebook/react/blob/main/scripts/rollup/modules.js#L31-L38)：
...
来源：[scripts/rollup/modules.js#L10-L38](https://github.com/facebook/react/blob/main/scripts/rollup/modules.js#L10-L38), [scripts/rollup/build.js#L656-L666](https://github.com/facebook/react/blob/main/scripts/rollup/build.js#L656-L666)
...
在 Facebook 构建中，多个公共入口点可能别名到单个内部入口点。例如，`react-dom` 和 `react-dom/client` 都解析到 `ReactDOMFB.js` [scripts/jest/setupHostConfigs.js#L18-L56](https://github.com/facebook/react/blob/main/scripts/jest/setupHostConfigs.js#L18-L56)。

### DevTools 集成

某些 bundle 用 DevTools hooks 包装代码以进行分析 [scripts/rollup/wrappers.js#L32-L51](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L32-L51)：
...
`react-reconciler` 包导出工厂函数而不是直接导出 [scripts/rollup/wrappers.js#L171-L263](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L171-L263)，允许自定义渲染器提供自己的 host 配置：
...
来源：[scripts/rollup/wrappers.js#L32-L51](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L32-L51), [scripts/rollup/wrappers.js#L171-L263](https://github.com/facebook/react/blob/main/scripts/rollup/wrappers.js#L171-L263), [scripts/jest/setupHostConfigs.js#L18-L56](https://github.com/facebook/react/blob/main/scripts/jest/setupHostConfigs.js#L18-L56)

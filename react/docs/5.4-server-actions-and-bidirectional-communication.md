...
本文档介绍 React 的 server action 系统和双向通信协议。Server actions 允许客户端代码调用服务端函数，建立从客户端到服务端的通信通道。这补充了 [React Server Components (Flight)](/5.2-react-server-components-(flight)) 中记录的服务端到客户端的 RSC 协议。
...
关于服务端到客户端的流式传输，请参阅 [React Server Components (Flight)](/5.2-react-server-components-(flight))。关于构建时模块解析，请参阅 [Build Integration for Server Components](/5.3-build-integration-for-server-components)。
...
Sources: [packages/react-server-dom-webpack/src/ReactFlightWebpackReferences.js#L111-L130](https://github.com/facebook/react/blob/main/packages/react-server-dom-webpack/src/ReactFlightWebpackReferences.js#L111-L130)
...
Sources: [packages/react-server-dom-webpack/src/ReactFlightWebpackReferences.js#L62-L103](https://github.com/facebook/react/blob/main/packages/react-server-dom-webpack/src/ReactFlightWebpackReferences.js#L62-L103)
...
Sources: [packages/react-client/src/ReactFlightReplyClient.js#L183-L465](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L183-L465)
...
Sources: [packages/react-client/src/ReactFlightReplyClient.js#L103-L170](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L103-L170)
...
Sources: [packages/react-client/src/ReactFlightReplyClient.js#L556-L607](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L556-L607)
...
Sources: [packages/react-client/src/ReactFlightReplyClient.js#L260-L304](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L260-L304), [packages/react-client/src/ReactFlightReplyClient.js#L306-L381](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L306-L381)
...
Sources: [packages/react-server/src/ReactFlightReplyServer.js#L1113-L1183](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightReplyServer.js#L1113-L1183)
...
Sources: [packages/react-server/src/ReactFlightReplyServer.js#L53-L107](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightReplyServer.js#L53-L107)
...
Sources: [packages/react-server/src/ReactFlightReplyServer.js#L595-L951](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightReplyServer.js#L595-L951)
...
Sources: [packages/react-server/src/ReactFlightReplyServer.js#L716-L778](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightReplyServer.js#L716-L778)
...
Sources: [packages/react-client/src/ReactFlightReplyClient.js#L642-L686](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L642-L686)
...
Sources: [packages/react-client/src/ReactFlightReplyClient.js#L688-L763](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L688-L763)
...
Sources: [packages/react-server/src/ReactFlightServer.js#L2507-L2566](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightServer.js#L2507-L2566)
...
Sources: [packages/react-server-dom-webpack/src/ReactFlightWebpackReferences.js#L77-L80](https://github.com/facebook/react/blob/main/packages/react-server-dom-webpack/src/ReactFlightWebpackReferences.js#L77-L80)
...
Sources: [packages/react-client/src/ReactFlightReplyClient.js#L466-L554](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L466-L554)
...
Sources: [packages/react-client/src/ReactFlightReplyClient.js#L306-L381](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L306-L381)
...
Sources: [packages/react-server/src/ReactFlightReplyServer.js#L352-L469](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightReplyServer.js#L352-L469)
...
Sources: [packages/react-server/src/ReactFlightReplyServer.js#L411-L469](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightReplyServer.js#L411-L469)
...
Sources: [packages/react-server/src/ReactFlightServer.js#L2507-L2566](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightServer.js#L2507-L2566), [packages/react-client/src/ReactFlightReplyClient.js#L183-L465](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L183-L465), [packages/react-server/src/ReactFlightReplyServer.js#L1113-L1183](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightReplyServer.js#L1113-L1183)
...
| 组件 | 文件路径 | 关键函数 |
|-----------|-----------|---------------|
| Server Reference 注册 | [packages/react-server-dom-webpack/src/ReactFlightWebpackReferences.js](https://github.com/facebook/react/blob/main/packages/react-server-dom-webpack/src/ReactFlightWebpackReferences.js) | `registerServerReference()`, `isServerReference()`, 自定义 `bind()` |
| Reply Encoding | [packages/react-client/src/ReactFlightReplyClient.js](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js) | `encodeReply()`, `processReply()`, `resolveToJSON()` |
| Reply Decoding | [packages/react-server/src/ReactFlightReplyServer.js](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightReplyServer.js) | `decodeReply()`, `processReplyChunk()`, `parseModelString()` |
| Server Reference 执行 | [packages/react-server/src/ReactFlightReplyServer.js#L716-L778](https://github.com/facebook/react/blob/main/packages/react-server/src/ReactFlightReplyServer.js#L716-L778) | Server reference 解析和绑定参数处理 |
| Form Action Encoding | [packages/react-client/src/ReactFlightReplyClient.js#L642-L763](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L642-L763) | `encodeFormAction()`, `encodeFormData()` |
| 绑定 Server References | [packages/react-client/src/ReactFlightReplyClient.js#L69-L71](https://github.com/facebook/react/blob/main/packages/react-client/src/ReactFlightReplyClient.js#L69-L71) | `createBoundServerReference()`, `registerBoundServerReference()` |
